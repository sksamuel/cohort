...
| `KafkaConsumerRateHealthCheck`    | `cohort-kafka`      | Checks that a Kafka Consumer is receiving a minimum number of requests per second.                                                                                                                                                               |
| `KafkaProducerRateHealthCheck`    | `cohort-kafka`      | Checks that a Kafka Producer is sending a minimum number of requests per second.                                                                                                                                                                 |
...
| `RabbitQueueHealthCheck`          | `cohort-redis`      | Checks for connectivity to, and existence of, a RabbitMQ queue.                                                                                                                                                                                  |
