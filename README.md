...
| `AzureBlobReadContainerHealthCheck`    | `cohort-azure`      | Checks for connectivity and permissions to read from an Azure Blob Storage container.                                                                                                                                                           |
| `AzureBlobWriteContainerHealthCheck`   | `cohort-azure`      | Checks for connectivity and permissions to write to an Azure Blob Storage container.                                                                                                                                                            |
