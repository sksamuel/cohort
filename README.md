...
| `GCSReadBucketHealthCheck`             | `cohort-gcp`        | Checks for connectivity and permissions to read from a Google Cloud Storage bucket.                                                                                                                                                             |
| `GCSWriteBucketHealthCheck`            | `cohort-gcp`        | Checks for connectivity and permissions to write to a Google Cloud Storage bucket.                                                                                                                                                              |
